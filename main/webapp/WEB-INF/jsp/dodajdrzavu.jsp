                ...
                <div class="row">
                    ...
                    <div class="container">
                        <div class="panel-body">
                            <c:choose>
                                <c:when test="${izmena}">
                                    <form id="register-form" action="${pageContext.request.contextPath}/admin/updatedrzavu?id=${drzava.id}" method="post" role="form">
                                </c:when>
                                <c:otherwise>    
                            <form id="register-form" action="${pageContext.request.contextPath}/admin/dodajdrzavu" method="post" role="form">
                            </c:otherwise>
                            </c:choose> 
                                   <div class="form-group">
                                            <input type="text" name="ime" id="ime" tabindex="1" class="form-control" placeholder="Ime drzave" value="${drzava.naziv}" required>
                                   </div>
                                        <div class="form-group">
                                            <div class="row">
