        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/admin/dodajadmina"><i class="fa fa-edit "></i>Dodaj Admina</a>
                    </li>
                    <li>
                ...
                <div class="row">
                    ...
                    <div class="container">
                        <div class="panel-body">
                            <form id="register-form" action="${pageContext.request.contextPath}/admin/dodajadmina" method="post" role="form">
                                <c:if test="${admin==0}">
                                    <p>
                                        ${mess}
                                    </p>
                                ...
                                <div class="form-group">
                                    <input type="text" name="adresa" id="adresa" tabindex="2" class="form-control" placeholder="Adresa" required>
                                </div>
                                <div class="form-group">
                                    <div class="row">
