...
<html>
    ...
    <body>
        ...
        <div id="page-wrapper" >
            ...
            <div id="page-inner">
                            <td><a href="${pageContext.request.contextPath}/admin/dodajrad" class="btn btn-primary">Dodaj Rad</a></td>
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <table class="table table-dark" >
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Izvodjac</th>
                                <th scope="col">Email</th>
                                <th scope="col">Telefon</th>                              
                               
                                <th scope="col">Obrisi Rad</th>
                            </tr>
                        ...
                        <c:forEach items="${radovi}" var="radovi">
                            <tbody>
                                ...
                                <tr>
                                    <th><c:out value="${radovi.id}"/></th>
                                    <th><c:out value="${radovi.lokacija}"/></th>
                                    <td><c:out value="${radovi.grdIme}"/></td>
                                    <td><c:out value="${radovi.drzIme}"/></td>
                                    <td><c:out value="${radovi.ime}"/></td>
                                    <th><c:out value="${radovi.email}"/></th>
                                    <td><c:out value="${radovi.telefon}"/></td>
                                                                   
                                 
                                    <td><a href="${pageContext.request.contextPath}/admin/obrisirad?id=<c:out value='${radovi.id}'/>" class="btn btn-primary">Obrisi rad</a></td>
                                </tr> 
