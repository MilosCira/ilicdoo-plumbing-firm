                        ...
                        <div class="panel-body">
                            <c:choose>
                                <c:when test="${izmena}">
                                    ...
                                    <c:otherwise>    
                                        <form id="register-form" action="${pageContext.request.contextPath}/admin/dodajgrad" method="post" role="form">
                                        </c:otherwise>
                                    </c:choose> 
                                    ...
                                    <select name="drzava">
                                        <c:forEach items="${drzave}" var="drzava">
                                            <option value=<c:out value="${drzava.id}"/> > <c:out value="${drzava.naziv}"/></option>
                                        </c:forEach>
                                    </select>
                                        </c:if>
                                    </div> 
