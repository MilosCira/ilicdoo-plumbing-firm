...
<html>
    ...
    <body>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <td><a href="${pageContext.request.contextPath}/admin/prikazidodajdrzavu" class="btn btn-primary"/>Dodaj Drzavu</a></td>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <c:forEach items="${drzava}" var="drzava">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><c:out value="${drzava.naziv}"/></td>
                                    <td><a href="${pageContext.request.contextPath}/admin/izmenidrzave?id=<c:out value='${drzava.id}'/>" class="btn btn-primary"/>Izmeni Drzavu</td>
                                    <td><a href="${pageContext.request.contextPath}/admin/obrisidrzavu?id=<c:out value='${drzava.id}'/>" class="btn btn-primary"/>Obrisi Drzavu</td>
                                </tr> 
                            </tbody>
                        </c:forEach>
                    </table>
