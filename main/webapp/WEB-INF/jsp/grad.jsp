...
<html>
    ...
    <body>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <td><a href="${pageContext.request.contextPath}/admin/prikazidodajgrad" class="btn btn-primary">Dodaj Grad</a></td>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <tbody>
                            <c:forEach items="${grad}" var="grad">
                                <tr>
                                    ...
                                    <td><a href="${pageContext.request.contextPath}/admin/izmenigrad?id=<c:out value='${grad.id}'/>" class="btn btn-primary"/>Izmeni Grad</td>
                                    <td><a href="${pageContext.request.contextPath}/admin/obrisigrad?id=<c:out value='${grad.id}'/>" class="btn btn-primary"/>Obrisi Grad</td>
                                </tr> 
