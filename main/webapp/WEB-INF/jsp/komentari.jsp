                    ...
                    <table class="table table-dark" >
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Izmeni Komentar</th>
                        ...
                        <c:forEach items="${komentari}" var="komentari">
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row"><c:out value="${komentari.id}"/></th>
                                    <td><c:out value="${komentari.komentar}"/></td>                                   
                                    <td> <c:out value="${komentari.ime}"/> <c:out value="${komentari.prezime}"/> </td>
                                  
                                    <td><a href="${pageContext.request.contextPath}/admin/izmenikomentar?id=<c:out value='${komentari.id}'/>" class="btn btn-primary"/>Izmeni Komentar</td>
                                    <td><a href="${pageContext.request.contextPath}/admin/obrisikomentar?id=<c:out value='${komentari.id}'/>" class="btn btn-primary"/>Obrisi Komentar</td>
                                </tr>
