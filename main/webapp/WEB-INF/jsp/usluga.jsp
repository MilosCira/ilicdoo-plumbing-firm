...
<html>
    ...
    <body>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <td><a href="${pageContext.request.contextPath}/admin/prikazidodajuslugu" class="btn btn-primary"/>Dodaj Uslugu</a></td>
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <table class="table table-dark" >
                        ...
                        <c:forEach items="${usluge}" var="usluga">
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row"><c:out value="${usluga.id}"/></th>
                                    <td><c:out value="${usluga.ime}"/></td>
                                    <td><c:out value="${usluga.prezime}"/></td>
                                    <td><c:out value="${usluga.imeUsluge}"/></td>
                                    <td><c:out value="${usluga.lokacija}"/></td>
                                    <td><c:out value="${usluga.cena}"/></td>
                                    
                                    
                                    <td><a href="${pageContext.request.contextPath}/admin/obrisiuslugu?id=<c:out value='${usluga.id}'/>" class="btn btn-primary"/>Obrisi Uslugu</td>
                                </tr>
